...
public class AppBase extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        divisions.add("1st Year,1st Semester");
        divisions.add("1st Year,2nd Semester");
        divisions.add("2nd Year,1st Semester");
        divisions.add("2nd Year,2nd Semester");
        divisions.add("3rd Year,1st Semester");
        divisions.add("3rd Year,2nd Semester");
        divisions.add("4th Year,1st Semester");
        divisions.add("4th Year,2nd Semester");
